...
export default class OfflineClient extends AbstractClient {
     ...
     */
    execute(apiFunction: IFunction, requestConfig?: RequestConfig): Promise<OfflineResponse>;
    /**
     ...
     * @return {Promise<OfflineResponse>}
     */
    executeBatch(apiFunctions: IFunction[], requestConfig?: RequestConfig): Promise<OfflineResponse>;
}
