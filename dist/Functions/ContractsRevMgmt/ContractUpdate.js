...
class ContractUpdate extends AbstractContract_1.default {
    writeXml(xml) {
        ...
        xml.writeElement("NAME", this.contractName);
        ...
        xml.writeElement("BILLINGFREQUENCY", this.billingFrequency);
...
exports.default = ContractUpdate;
//# sourceMappingURL=ContractUpdate.js.map