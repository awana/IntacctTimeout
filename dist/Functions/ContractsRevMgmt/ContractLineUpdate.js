...
class ContractLineUpdate extends AbstractContractLine_1.default {
    writeXml(xml) {
        ...
        xml.writeElement("BILLINGMETHOD", this.billingMethod);
...
exports.default = ContractLineUpdate;
//# sourceMappingURL=ContractLineUpdate.js.map