...
class VendorCreate extends AbstractVendor_1.default {
    writeXml(xml) {
        ...
        xml.writeElement("NAME", this.vendorName, true);
        ...
        if (this.printAs === null || this.printAs === "") {
            xml.writeElement("PRINTAS", this.vendorName, true);
        }
        else {
...
exports.default = VendorCreate;
//# sourceMappingURL=VendorCreate.js.map