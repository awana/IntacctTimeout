...
class LessThanOrEqualToInteger extends AbstractInteger_1.default {
    toString() {
        let clause = "";
        if (this.negate === true) {
            clause = "NOT ";
...
exports.default = LessThanOrEqualToInteger;
//# sourceMappingURL=LessThanOrEqualToInteger.js.map